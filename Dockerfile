...
# add ruby and jekyll
# 安装 pkg-config 和 imagemagick
RUN apt-get update -qq && apt-get install --no-install-recommends ruby-full build-essential zlib1g-dev -y
RUN apt-get install libpq-dev pkg-config imagemagick libmagickwand-dev -y
